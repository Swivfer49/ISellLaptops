...
namespace ISellLaptops.Controllers
{
    public class LaptopsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,Price,Year")] Laptop laptop)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,Price,Year")] Laptop laptop)
        {
            if (id != laptop.Id)
            {
                return NotFound();
